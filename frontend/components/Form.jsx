...
const Form = () => {
  ...
  const handleCreateToken = async () => {
    ...
    try {
      ...
      console.log("Token Details: ", result.receipt.events[4].args);

      const newTokenAddress = result.receipt.events[4].args[0];
      const newTokenName = result.receipt.events[4].args[1];
      const newTokenSymbol = result.receipt.events[4].args[2];
